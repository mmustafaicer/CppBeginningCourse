...
//    vector <char> vowels (5);      // 5 characters long and all initialized to zero 
...
//   vector <int> test_scores (3, 100); // 3 elements all initialized to 100
    ...
    // you can use .size() method for length.
    ...
    test_scores.push_back(score_to_add);  // use push_back method to append to end of vector.
  ...
  //  cout << "This should cause an exception!!" << test_scores.at(10) << endl;
    ...
    // NOTE THAT we are declaring vector two times since it is 2 dimensional
